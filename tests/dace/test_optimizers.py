...
from pysurrogate.dace.corr import Correlation, Gaussian
from pysurrogate.dace.dace import Dace
from pysurrogate.dace.fit import fit
from pysurrogate.dace.optimizers import LBFGS, objective_gradient
...
def test_relaxed_lbfgs_saves_evaluations_and_stays_close():
    ...
    import pysurrogate.dace.optimizers.lbfgs as lb
