# pysurrogate documentation builder

The documentation pipeline for pysurrogate. `pyclawd docs` delegates to this
...
Environment overrides: `PYSURROGATE_DOCS_TIMEOUT` (per-cell seconds),
`PYSURROGATE_DOCS_JOBS` (parallel workers).
